...
Scenario: Acessar restaurante através de pedido do histórico
    ...
    When eu clico no nome "0000's Diner" no primeiro pedido da lista "pedidos"
...
Scenario: Acessar item através de pedido do histórico
    ...
    Then eu estou na página "cardapio" do restaurante de id "f257adef-dda8-46c7-bbfd-4275a90d837e" no item de id "0"
