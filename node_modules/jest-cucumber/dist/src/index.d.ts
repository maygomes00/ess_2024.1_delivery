...
export declare const autoBindSteps: <C extends {} = {}>(parsedFeatures: import("./models").ParsedFeature | import("./models").ParsedFeature[], stepDefinitions: import("./feature-definition-creation").StepsDefinitionCallbackFunctionWithContext<C>[]) => void;
