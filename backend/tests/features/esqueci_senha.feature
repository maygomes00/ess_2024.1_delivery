...
Cenário: Solicitar envio de link para recuperar senha por e-mail com e-mail correto
    Given acesso a rota "/forgot-password"
    When  realizo uma requisição "POST" com o email "
...
Cenário: Inserção de nova senha válida
    Given o usuário "user" está na página de "Criar nova Senha"
    When o usuário insere uma "Nova Senha" como "senha123"
